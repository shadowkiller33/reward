...
class ScriptArguments:
    ...
    adapter_model_name: Optional[str] = field(default='mnoukhov/llama-7b-se-rm-peft', metadata={"help": "the model name"})
    base_model_name: Optional[str] = field(default='/home/lingfelshen/llama-7b-hf', metadata={"help": "the model name"})
